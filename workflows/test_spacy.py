...
if __name__ == "__main__":
    ...
    parser.add_argument("--decont_url", type=str, default="http://localhost:5002/nlp/spacy_ner", help="The URL of the tokenizer API. Default: %(default)s")
...
# Conduct a test:
# python3 workflows/test_spacy.py --doc_dir "/home/sjin824/pyprojects/mag/tests/mock_data"
